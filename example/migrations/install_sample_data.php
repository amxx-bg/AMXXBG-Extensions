...
class install_sample_data extends \phpbb\db\migration\migration
{
	...
	{
		return $this->config->offsetExists('Example_example_sample_int');
	}
	...
	public function update_data()
	{
		return array(
			...
			array('config.add', array('Example_example_sample_int', 0)),
			array('config.add', array('Example_example_sample_str', '')),

			// Add a new config_text table setting
			array('config_text.add', array('Example_example_sample', '')),

			// Add new permissions
			array('permission.add', array('a_new_Example_example')), // New admin permission
			array('permission.add', array('m_new_Example_example')), // New moderator permission
			array('permission.add', array('u_new_Example_example')), // New user permission
			...
			array('permission.permission_set', array('ROLE_ADMIN_FULL', 'a_new_Example_example')), // Give ROLE_ADMIN_FULL a_new_Example_example permission
			array('permission.permission_set', array('ROLE_USER_FULL', 'u_new_Example_example')), // Give ROLE_USER_FULL u_new_Example_example permission
			array('permission.permission_set', array('ROLE_USER_STANDARD', 'u_new_Example_example')), // Give ROLE_USER_STANDARD u_new_Example_example permission
			array('permission.permission_set', array('REGISTERED', 'u_new_Example_example', 'group')), // Give REGISTERED group u_new_Example_example permission
			array('permission.permission_set', array('REGISTERED_COPPA', 'u_new_Example_example', 'group', false)), // Set u_new_Example_example to never for REGISTERED_COPPA

			// Add new permission roles
			array('permission.role_add', array('example admin role', 'a_', 'a new role for admins')), // New role "example admin role"
			array('permission.role_add', array('example moderator role', 'm_', 'a new role for moderators')), // New role "example moderator role"
			array('permission.role_add', array('example user role', 'u_', 'a new role for users')), // New role "example user role"
