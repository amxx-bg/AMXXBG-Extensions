...
namespace Example\example\event;
...
class main_listener implements EventSubscriberInterface
{
	...
	public function add_page_header_link()
	{
		$this->template->assign_vars(array(
			'U_EXAMPLE_PAGE'	=> $this->helper->route('Example_example_controller', array('name' => 'world')),
		));
	}

	/**
	 * Show users viewing Example page on the Who Is Online page
	 *
	 * @param \phpbb\event\data	$event	Event object
	 */
	public function viewonline_page($event)
	{
		...
		{
			$event['location'] = $this->language->lang('VIEWING_EXAMPLE_EXAMPLE');
			$event['location_url'] = $this->helper->route('Example_example_controller', array('name' => 'world'));
		}
	}
	...
	public function display_forums_modify_template_vars($event)
	{
		...
		$forum_row['FORUM_NAME'] .= $this->language->lang('EXAMPLE_EVENT');
	 ...
	 * to allow only users with the a_new_Example_example permission
	...
	public function add_permissions($event)
	{
		...
		$permissions['a_new_Example_example'] = array('lang' => 'ACL_A_NEW_EXAMPLE_EXAMPLE', 'cat' => 'misc');
		$permissions['m_new_Example_example'] = array('lang' => 'ACL_M_NEW_EXAMPLE_EXAMPLE', 'cat' => 'post_actions');
		$permissions['u_new_Example_example'] = array('lang' => 'ACL_U_NEW_EXAMPLE_EXAMPLE', 'cat' => 'post');
