...
namespace evilsystem\amxxmonitoring\event;
...
/**
 * Server Monitoring Event listener.
 */
class main_listener implements EventSubscriberInterface
{
	...
	public function load_language_on_setup($event)
	{
		...
		$lang_set_ext[] = array(
			'ext_name' => 'evilsystem/amxxmonitoring',
			'lang_set' => 'common',
		);
	...
	public function add_page_header_link()
	{
		$this->template->assign_vars(array(
			'U_AMXXMONITORING_PAGE'	=> $this->helper->route('evilsystem_amxxmonitoring_controller', array('name' => 'all')),
		));
	}

	/**
	 * Show users viewing Server Monitoring page on the Who Is Online page
	 *
	 * @param \phpbb\event\data	$event	Event object
	 */
	public function viewonline_page($event)
	{
		if ($event['on_page'][1] === 'app' && strrpos($event['row']['session_page'], 'app.' . $this->php_ext . '/servers') === 0)
		{
